 ...
 * class is essentially a port from Penner's ActionScript utility, with a few added tweaks.
 * </p>
 * <p>
 * Examples:
 * 
...
public interface Easing {
   ...
   */
  public static final Easing QUAD_OUT = (t, b, c, d) -> -c * (t /= d) * (t - 2) + b;
   ...
   */
  public static final Easing CUBIC_OUT = (t, b, c, d) -> c * ((t = t / d - 1) * t * t + 1) + b;
   ...
   */
  public static final Easing QUARTIC_OUT = (t, b, c, d) -> -c * ((t = t / d - 1) * t * t * t - 1) + b;
   ...
   */
  public static final Easing QUINTIC_OUT = (t, b, c, d) -> c * ((t = t / d - 1) * t * t * t * t + 1) + b;
   ...
   */
  public static final Easing SINE_IN = (t, b, c, d) -> -c * (float) Math.cos(t / d * (Math.PI / 2)) + c + b;

  /**
   * Sinusoidal easing out - decelerating to zero velocity.
   */
  public static final Easing SINE_OUT = (t, b, c, d) -> c * (float) Math.sin(t / d * (Math.PI / 2)) + b;

  /**
   * Sinusoidal easing in/out - accelerating until halfway, then decelerating.
   */
  public static final Easing SINE_IN_OUT = (t, b, c, d) -> -c / 2 * ((float) Math.cos(Math.PI * t / d) - 1) + b;
   ...
   */
  public static final Easing EXPO_IN = (t, b, c, d) -> (t == 0) ? b : c * (float) Math.pow(2, 10 * (t / d - 1)) + b;

  /**
   * Exponential easing out - decelerating to zero velocity.
   */
  public static final Easing EXPO_OUT = (t, b, c, d) -> (t == d) ? b + c : c * (-(float) Math.pow(2, -10 * t / d) + 1) + b;
   ...
   */
  public static final Easing CIRC_IN = (t, b, c, d) -> -c * ((float) Math.sqrt(1 - (t /= d) * t) - 1) + b;

  /**
   * Circular easing out - decelerating to zero velocity.
   */
  public static final Easing CIRC_OUT = (t, b, c, d) -> c * (float) Math.sqrt(1 - (t = t / d - 1) * t) + b;
  ...
  public static class ElasticOut extends Elastic {
    ...
    public float ease(float t, float b, float c, float d) {
      ...
      if (a < Math.abs(c)) {
        ...
        s = p / (float) (2 * Math.PI) * (float) Math.asin(c / a);
      return a * (float) Math.pow(2, -10 * t) * (float) Math.sin((t * d - s) * (2 * Math.PI) / p)
          + c + b;
    }
  }
  ...
  public static abstract class Back implements Easing {
     ...
     * 
     * @param overshoot the amount to overshoot by -- higher number means more overshoot and an
     *        overshoot of 0 results in cubic easing with no overshoot
     */
  ...
  /**
   * Back easing out - moving towards target, overshooting it slightly, then reversing and coming
   * back to target.
   */
  ...
  /**
   * Back easing in/out - backtracking slightly, then reversing direction and moving to target, then
   * overshooting target, reversing, and finally coming back to target.
   */
  ...
  /** Bounce easing in. */
  public static final Easing BOUNCE_IN = (t, b, c, d) -> c - Easing.BOUNCE_OUT.ease(d - t, 0, c, d) + b;
